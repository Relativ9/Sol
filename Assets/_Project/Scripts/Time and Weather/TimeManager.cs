...
// {
//     /// <summary>
//     /// Core time management system that handles game time progression, season tracking, and temporal events.
...
//
//         /// <summary>
//         /// Updates all time-related information including seasons, time of day, and cached game time.
...
//                 // TimeEvents.OnTimeScaleChanged?.Invoke(previousTimeScale, timeScale);
//                 
//                 if (enableDebugLogging)
//                 {
...
//         /// Automatically updates season and other dependent values.
//         /// </summary>
...
//
//             return $"Time: {CurrentTimeDisplay}\n" +
//                    $"Date: Day {currentDay} of {worldTimeData.totalDaysInYear}, Year {currentYear}\n" +
