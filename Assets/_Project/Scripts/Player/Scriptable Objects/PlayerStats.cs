...
namespace Sol
{
    ...
    public class PlayerStatSO : ScriptableObject
    {
        ...
        public float baseEnergy = 100f; //Global resource, spells, attacks, sprinting, jumping, abilities, etc all use Energy.
        ...
        public float baseClueRange = 0f; //Spells which highlight loot and secrets add to this range, as does certain talents.
